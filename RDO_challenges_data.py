...
predefined_challenges = [
    ...
    {"name": "Defended a campsite", "key": "mpgc_dynamic_campsite_defend", "category": ["menu", "defend_campsite"],
             "description": "Stand by the door of the New Austin moonshine shack, and spawn a wilderness camp, which should put you on top of the cliffs. There's then usually a campsire to defend near the 'N' of 'AUSTIN' on the map.",
