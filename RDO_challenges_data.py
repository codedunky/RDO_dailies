...
predefined_challenges = [
    ...
    {"name": "Camp themes updated", "key": "mpgc_customization_camp_style", "showgoal": "y"},
    ...
    {"name": "Cats photographed", "key": "mpgc_photograph_cat", "showgoal": "y"},
    {"name": "Chain Pickerel caught", "key": "mpgc_fish_caught_chain_pickerel", "category": ["fish", "chainpickerel"]},
    {"name": "Channel Catfish caught", "key": "mpgc_fish_caught_channel_catfish", "category": ["fish", "channelcatfish"], "showgoal": "y",
    ...
    {"name": "Chanterelle picked", "key": "mpgc_chanterelle_picked", "category": ["plants", "chanterelles"],
             "description": "Just to the west of Rhodes station is one patch, then ride due west again, almost to the coastline.\nOn the spur of land that sticks out into the lake, there are a couple of patches in the centre of the woods."},
    ...
    {"name": "Collared Peccaries skinned", "key": "mpgc_javelina_skinned", "category": ["animal", "javelina"],"showgoal": "y",
    ...
    {"name": "Cooked Seasoned Exotic Bird", "key": "mpgc_craft_exotic_bird_seasoned", "category": ["menu", "campfires"],"showgoal": "y",
    ...
    {"name": "Distance driven a train", "key": "mpgc_distance_driven_train", "category": ["menu", "trains"],
             "description": "Fast travel to MacFarlane's Ranch, as a train usually shows up there.\nTake over the train when in the tunnel to avoid a wanted level."},
    ...
    {"name": "Dogs photographed", "key": "mpgc_photograph_dog", "category": ["animal", "dog_street"], "showgoal": "y"},
    ...
    {"name": "Hamish Sinclair missions completed", "key": "mpgc_gfh_hamish_sinclair_wins", "category": ["gfh", "war_vet"], "showgoal": "y"},
    ...
    {"name": "James Langton missions completed", "key": "mpgc_gfh_james_langton_wins", "category": ["gfh", "langton"], "showgoal": "y"},
    {"name": "Joe missions completed", "key": "mpgc_gfh_joe_wins", "category": ["gfh", "joe"], "showgoal": "y"},
    ...
    {"name": "Player kills from the hip in Showdowns", "key": "mpgc_players_killed_from_hip_showdown", "showgoal": "y"},
    ...
    {"name": "Shaky missions completed", "key": "mpgc_gfh_shaky_wins", "category": ["gfh", "shaky"], "showgoal": "y"},
    ...
    {"name": "Telegram missions completed", "key": "mpgc_telegram_mission_wins", "showgoal": "y"},
    {"name": "The Boy missions completed", "key": "mpgc_gfh_the_boy_wins", "category": ["gfh", "the_boy"], "showgoal": "y"},
    ...
    {"name": "Train clerk missions completed", "key": "mpgc_gfh_train_clerk_wins", "category": ["gfh", "wallace_train_clerk"], "showgoal": "y"},
    {"name": "Treasure Maps or treasures found", "key": "mpgc_dynamic_found_treasure_or_map", "category": ["menu", "tree_map"], "showgoal": "y",
             "description": "Much easier to use an existing treasure map to find some treasure, than it is to search bodies or find one\npinned to a tree."},
...
trader = [
    ...
    {"name": "Cripps Special Camp Stew recipes completed", "key": "mprc_trader_stew_recipe_completed_cripps", "showgoal": "y"},
    {"name": "Distance Delivery Wagon traveled on mission", "key": "mprc_trader_travel_wagon",
             "description": "Use a Change Appearance solo lobby to be sure it registers"},
    ...
    {"name": "Goods sold to local buyer", "key": "mprc_trader_goods_sold_local", "showgoal": "y"},
    ...
    {"name": "Money made from trading", "key": "mprc_trader_money_made", "showgoal": "y"},
    {"name": "Perfect carcasses donated to Cripps", "key": "mprc_trader_supplies_donated_carcass_perfect",
             "description": "Perfect pelts don't count for this."},
    {"name": "Resupply completed with 3 mins left", "key": "mprc_trader_resupply_completed_timed_easy", "showgoal": "y"},
    {"name": "Resupply completed with 4 mins left", "key": "mprc_trader_resupply_completed_timed_med", "showgoal": "y"},
    {"name": "Resupply completed with 5 mins left", "key": "mprc_trader_resupply_completed_timed_hard", "showgoal": "y"},
    {"name": "Resupply missions completed", "key": "mprc_trader_resupply_completed", "showgoal": "y"},
    {"name": "Small animal carcasses donated to Cripps", "key": "mprc_trader_supplies_donated_animal_small", "showgoal": "y"},
    {"name": "Superior Quality Camp Stew recipes completed", "key": "mprc_trader_stew_recipe_completed_superior", "showgoal": "y"}
  ]
 
collector = [
    {"name": "American Wild Flowers found", "key": "mprc_collector_wild_flowers_found", "showgoal": "y"},
    {"name": "Antique Alcohol Bottles found", "key": "mprc_collector_antique_bottles_found", "category": ["menu", "moonshiner_roadblock"], "showgoal": "y"},
    {"name": "Antique Alcohol drunk", "key": "mprc_collector_antique_alcohol_drunk", "category": ["menu", "moonshiner_roadblock"], "showgoal": "y"},
    {"name": "Arrowheads found", "key": "mprc_collector_arrowheads_found", "showgoal": "y"},
    {"name": "Bird Eggs found", "key": "mprc_collector_bird_eggs_found", "showgoal": "y"},
    {"name": "Coins found", "key": "mprc_collector_coins_found", "showgoal": "y"},
    {"name": "Collectibles collected", "key": "mprc_collector_items_collected", "showgoal": "y"},
    {"name": "Collectibles found with a Metal Detector", "key": "mprc_collector_used_metal_dectector", "showgoal": "y"},
    {"name": "Collectibles found with a Shovel", "key": "mprc_collector_used_shovel", "showgoal": "y"},
    {"name": "Collectibles looted from non-player enemies", "key": "mprc_collector_items_looted_enemy", "showgoal": "y"},
    {"name": "Collectibles sold to Madam Nazar", "key": "mprc_collector_items_sold", "category": ["nazar", "madam_nazar"], "showgoal": "y"},
    {"name": "Collector Maps used", "key": "mprc_collector_used_map", "category": ["nazar", "madam_nazar"], "showgoal": "y"},
    {"name": "Family Heirlooms found", "key": "mprc_collector_family_heirlooms_found", "showgoal": "y"},
    {"name": "Fossils found", "key": "mprc_collector_fossils_found", "showgoal": "y"},
    {"name": "Lost Jewelry found", "key": "mprc_collector_lost_jewelry_found", "showgoal": "y"},
    {"name": "Tarot Cards found", "key": "mprc_collector_tarot_cards_found", "showgoal": "y"}
  ]
 
bounty_hunter = [
    {"name": "Bounties brought in from Lemoyne posters", "key": "mprc_bounty_location_lemoyne", "showgoal": "y",
             "description": "Rhodes and Saint Denis"},
    {"name": "Bounties brought in from New Austin posters", "key": "mprc_bounty_location_new_austin", "showgoal": "y",
             "description": "Armadillo, Tumbleweed and Benedict Point"},
    {"name": "Bounties brought in from New Hanover posters", "key": "mprc_bounty_location_new_hanover", "showgoal": "y",
             "description": "Valentine, Emerald Station, Van Horn and Annesburg"},
    {"name": "Bounties brought in from West Elizabeth posters", "key": "mprc_bounty_location_west_elizabeth", "showgoal": "y",
             "description": "Strawberry, Blackwater, Wallace Station, and Riggs Station"},
    {"name": "Bounties completed within one real-world hour", "key": "mprc_bounty_completed_timed", "showgoal": "y"},
    {"name": "Bounty completed with at least one other Posse Member", "key": "mprc_bounty_completed_posse_member", "showgoal": "y"},
    ...
    {"name": "Bounty targets brought in", "key": "mprc_bounty_general_delivered", "showgoal": "y"},
    {"name": "Bounty targets hogtied with a Reinforced Lasso", "key": "mprc_bounty_used_reinforced_lasso", "showgoal": "y"},
    {"name": "Bounty targets lassoed from horseback", "key": "mprc_bounty_used_lasso_horseback", "showgoal": "y"},
    {"name": "Bounty targets looted", "key": "mprc_bounty_targets_looted", "showgoal": "y"},
    {"name": "Bounty targets tagged with Tracking Arrow", "key": "mprc_bounty_used_track_arrow", "showgoal": "y"},
    {"name": "Bounty targets taken down with Bolas", "key": "mprc_bounty_used_bolas", "showgoal": "y"},
    {"name": "Eagle Eye used to track a bounty target", "key": "mprc_bounty_used_eagle_eye", "showgoal": "y",
    ...
    {"name": "Hard ($$$) or Legendary Bounty mission completed", "key": "mprc_bounty_mission_completed_hard", "showgoal": "y"},
    {"name": "Living bounty targets in a photograph", "key": "mprc_bounty_target_photographed_alive", "showgoal": "y"},
    {"name": "Medium ($$) bounty mission completed", "key": "mprc_bounty_mission_completed_medium"},
    {"name": "More than one bounty target brought in at once", "key": "mprc_bounty_general_delivered_multi_target", "showgoal": "y"},
    {"name": "Player bounties collected", "key": "mprc_bounty_player_completed", "showgoal": "y"}
  ]
...
moonshiner = [
    ...
    {"name": "Distance Moonshine Wagon traveled on mission", "key": "mprc_moonshiner_travel_wagon", "showgoal": "y"},
    ...
    {"name": "Money made from moonshine sold", "key": "mprc_moonshiner_money_made", "showgoal": "y"},
    ...
    {"name": "Moonshine Bar - Drunken player interaction", "key": "mprc_moonshiner_drunk_interaction_bar",
             "description": "If solo, use Y then B button combo as entering shack", "showgoal": "y"},
    {"name": "Moonshine Bar - Stayed for the last round", "key": "mprc_moonshiner_last_round_bar"},
    {"name": "Moonshine Bootlegger Missions completed", "key": "mprc_moonshiner_marketing_mission_completed", "showgoal": "y"},
    {"name": "Moonshine of any type sold to a buyer", "key": "mprc_moonshiner_moonshine_sold_buyer"},
    {"name": "Moonshine of preferred type sold to a buyer", "key": "mprc_moonshiner_moonshine_sold_buyer_hard", "showgoal": "y"},
    {"name": "Moonshine served to other players at a bar", "key": "mprc_moonshiner_moonshine_served_bar", "showgoal": "y"},
    ...
    {"name": "Moonshine Story Mission completed", "key": "mprc_moonshiner_story_mission_completed", "showgoal": "y"},
...
naturalist = [
    {"name": "Animal samples sold to Harriet", "key": "mprc_naturalist_samples_sold", "showgoal": "y"},
    {"name": "Animal samples taken within 10 mins", "key": "mprc_naturalist_samples_taken_timed", "showgoal": "y"},
    {"name": "Blending Tonics crafted or used", "key": "mprc_naturalist_crafted_blending_tonic", "showgoal": "y"},
    {"name": "Crafted or cooked at Wilderness Camp", "key": "mprc_naturalist_crafted_cooked_wilderness_camp", "showgoal": "y"},
    {"name": "Desert animal samples taken", "key": "mprc_naturalist_sample_animal_desert", "showgoal": "y"},
    ...
    {"name": "Farmland animal samples taken", "key": "mprc_naturalist_sample_animal_domesticated", "showgoal": "y"},
    {"name": "Forest/River animal samples taken", "key": "mprc_naturalist_sample_animal_forest", "showgoal": "y"},
    {"name": "Hardy Tonics used when too hot or cold", "key": "mprc_naturalist_used_hardy_tonic", "showgoal": "y"},
    {"name": "Legendary Animal samples taken", "key": "mprc_naturalist_sample_animal_legendary", "showgoal": "y"},
    {"name": "Legendary Animals found using pheromones", "key": "mprc_naturalist_used_legendary_bait", "showgoal": "y"},
    {"name": "Legendary Animals photographed", "key": "mprc_naturalist_photo_animal_legendary", "showgoal": "y"},
    {"name": "Mountain/Grassland animal samples taken", "key": "mprc_naturalist_sample_animal_grassland", "showgoal": "y"},
    {"name": "Sedated animals revived", "key": "mprc_naturalist_tranq_animal_revived", "showgoal": "y"},
    {"name": "Weight Change Tonics used", "key": "mprc_naturalist_used_weight_tonic", "showgoal": "y"},
    {"name": "Wetland animal samples taken", "key": "mprc_naturalist_sample_animal_swamp", "showgoal": "y"}
  ]
