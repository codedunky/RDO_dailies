...
predefined_challenges = [
    ...
    {"name": "American Bullfrogs collected", "key": "mpgc_bullfrogs_skinned", "category": ["animal", "frogbull"],
             ...
             "description2": "Head east from Lagras and then north to the spur of land above Copperhead Landing, there are often bullfrogs to catch."},
    ...
    {"name": "American Muskrats skinned", "key": "mpgc_muskrats_skinned", "category": ["animal", "muskrat"],
             "description": "The large island in Lake Flat iron, opposite Clemens Point always has a lot of Muskrats to shoot",
             "description2": "The San Luis River is a great place to hunt them. Some just south of Scratching Post, while the stretch below Plainview to Rio Del Lobo Rock also finds them along the river bank.\nQuite a lot of them around Bluewater Marsh as well."},
    ...
    {"name": "Animals killed with a knife", "key": "mpgc_animal_knife_kills",
             ...
             "description2": "Rathskeller Fork, north of Tumbleweed has chickens which can be stabbed easily."},
    ...
    {"name": "Animals stowed on horseback", "key": "mpgc_horse_stowed_animals",
             "description": "These can also be small animals like American Badgers stowed on the side of the horse."},
    {"name": "Animals trampled", "key": "mpgc_horse_animals_trampled",
             ...
             "description2": "The big island with the shipwreck in Flat Iron Lake, west of Rhodes, has a lot of Green Iguana's that you can trample as you ride around the beaches."},
    ...
    {"name": "Bay Bolete picked", "key": "mpgc_bay_bolete_picked", "category": ["plants", "bay_bolete"],
             ...
             "description2": "Ride west out of Valentine, and where the little track hits a junction under the 'N' of Valentine is an easy to find patch. Then head southwest into the trees near Lucky's Cabin for more."},
    ...
    {"name": "Beavers skinned", "key": "mpgc_beavers_skinned", "category": ["animal", "beaver"],
             "description": "From Strawberry, head to Owanjia Dam, there's usually a beaver by the water as you approach. Then just keep going around the shoreline for more. Change lobbies to get more spawns. They're timid, so Blending Tonics are useful. Varmint Rifle and a head shot for clean kills."},
    ...
    {"name": "Bison skinned", "key": "mpgc_buffalo_skinned", "category": ["animal", "buffalo"],
             "description": "West of Heartland Overflow, west and northwest of the 'A' in New Hanover.\nThe other good spot is on the Great Plains, southwest of Blackwater. They tend to spawn during the day but not exclusively."},
    {"name": "Black-tailed Jackrabbits skinned", "key": "mpgc_rabbits_skinned", "category": ["animal", "rabbit"],
             "description": "These are everywhere until they're a daily challenge when they all disappear. A reliable place though, is the big island off the coast of Clemens Point near Rhodes."},
    {"name": "Blackberries picked", "key": "mpgc_black_berry_picked", "category": ["plants", "black_berry"],
             "description": "Go to Mazanita Post, there are some just to the north west of the main building. Then head directly east across the road and into the trees for more. More bushes around the junction to the north as well."},
    {"name": "Blackcurrants picked", "key": "mpgc_black_currant_picked", "category": ["plants", "black_currant"],
             ...
             "description2": "Go to Armadillo, and take the northwest road over the railway tracks towards the Pleasance House. There are quite a few plants around the triangular junction that goes to Twin Rocks, above the 'GS' of 'SPRINGS' on the map."},
    ...
    {"name": "Bluegill caught", "key": "mpgc_fish_caught_bluegill", "category": ["fish", "bluegill"],
             "description": "Try on the western edge of Saint Denis by the semaphore signal that's just before the railroad bridge. Cheese bait is effective.",
             "description2": "Travel to Rhodes, then north to Mattock Pond. It might look empty of fish, but it's exclusively Bluegills. Just start fishing with some cheese bait and they will appear."},
    ...
    {"name": "Bulls skinned", "key": "mpgc_bulls_skinned", "category": ["animal", "bull_devon"],
             "description": "Found at two farms. Try Hill Haven Ranch, north of Rhodes, and east of Mattock Pond. Also at Carmody Dell, northeast of Cornwall Kerosene & Tar.\nSolo lobbies and switching lobbies to encourage a spawn are recommended. Oxen don't count either."},
    {"name": "Burdock Roots picked", "key": "mpgc_burdock_root_picked", "category": ["plants", "burdock_root"],
             ...
             "description2": "The big island off the coast of Clemens Point near Rhodes has plenty of Burdock to pick, mainly at the south east corner."},
    ...
    {"name": "Capitale notes collected", "key": "mpgc_capitale_notes_collected",
             "description": "Go to Rhodes and then Anthony Foreman, as the Blood Money Mission, 'The Railroad Contract' is a very good one to find capitale. Part 1 has some in a box at the campsite for example. You can collect it, then abandon to the main menu, and restart the mission to farm it."},
    ...
    {"name": "Chain Pickerel caught", "key": "mpgc_fish_caught_chain_pickerel", "category": ["fish", "chainpickerel"],
             ...
             "description2": "Use corn for bait, and try Cattail Pond to the west of Valentine.",
             "description3": "The Dakota River, just west of the burned town of Limpany, is a good spot. Use corn for bait."},
    {"name": "Channel Catfish caught", "key": "mpgc_fish_caught_channel_catfish", "category": ["fish", "channelcatfish"], "showgoal": "yes",
             ...
             "description2": "Directly opposite the fast travel post at Lagras, between the house and the large boat on the bank of the Kamassa River is a good spot to find Channel Catfish. Use a Special Swamp Lure."},
    {"name": "Chanterelle picked", "key": "mpgc_chanterelle_picked", "category": ["plants", "chanterelles"],
             "description": "Just to the west of Rhodes station is one patch on the boundary line and near the fallen tree trunks, then ride due west again, almost to the coastline. On the spur of land that sticks out into the lake, there are a couple of patches in the centre of the woods.",
             "description2": "Go to Emerald Station, and take the road east across the train tracks. There's a patch in the trees just east of the 'D' in 'EMERALD', then head north east for another patch in another group of trees."},
    ...
    {"name": "Common Bulrush picked", "key": "mpgc_common_bulrush_picked", "category": ["plants", "common_bulrush"],
             "description": "Just north of Rhodes at Southfield Flats there are plenty of easily reachable bulrushes.",
             "description2": "Just north of Rhodes at Mattock Pond is a good place to collect them."},
    {"name": "Complimentary snacks eaten at a Saloon", "key": "mpgc_consumable_saloon_snacks_eaten", "category": ["shops", "saloon"],
             "description": "At your moonshiner shack bar counts for this. Alternatively, the Blackwater Saloon has almonds on the far right end of the bar. Smithfields Saloon in Valentine has both almonds and pickled eggs. You can get almonds at the The Rhodes Parlour House, and finally at the Bastile Saloon in Saint Denis too."},
    ...
    {"name": "Cooked Seasoned Big Game", "key": "mpgc_craft_big_game_seasoned", "category": ["menu", "campfires"],
             "description": "Big game can be got from Alligators, Wolves, Cougars, Panthers, Black Bears and Grizzly Bears."},
    ...
    {"name": "Cooked Seasoned Pork", "key": "mpgc_craft_pork_seasoned", "category": ["menu", "campfires"],
             ...
             "description2": "Wild Boar will give pork to cook. Black Bone Forest up near the west of Big Valley has plenty to kill."},
    ...
    {"name": "Cormorants plucked", "key": "mpgc_cormorant_skinned", "category": ["animal", "cormorant_doublecrested"],"showgoal": "yes",
    ...
    {"name": "Cougars killed", "key": "mpgc_cougars_killed", "category": ["animal", "cougar"],
             ...
             "description2": "Take the southern road out of Blackwater and follow the road towards Quaker's Cove. Cougars often attack around the wooden bridge area, between the 'H' and 'Plains' on the map.",
             "description3": "Try Harriet's mission to sample the Legendary Sapa Cougar. Up at Tumbleweed, you'll get attacked by a couple of cougars out in the desert. Kill them."},
    ...
    {"name": "Creeping Thyme picked", "key": "mpgc_creeping_thyme_picked", "category": ["plants", "creeping_thyme"],
             ...
             "description2": "Fast travel to Emerald Station, then go northeast across the train tracks. In the area between the train track and the road above 'EMERALD STATION' on the map are a couple of patches, with more beside the railway line if you follow the curve northeast."},
    ...
    {"name": "Deer skinned", "key": "mpgc_deer_skinned", "category": ["animal", "deer"],
             "description": "Deer are fairly common over most of New Hanover, West Elizabeth and Lemoyne. Scarlett Meadows, Big Valley and to the East of Emerald station are all good spots too. Please note that Pronghorns do not count. It has to be Whitetails. A Whitetail Buck will count though."},
    {"name": "Defended a campsite", "key": "mpgc_dynamic_campsite_defend", "category": ["menu", "defend_campsite"],
             "description": "Stand by the door of the New Austin moonshine shack, and spawn a wilderness camp, which should put you on top of the cliffs. There's then usually a campsite to defend near the 'N' of 'AUSTIN' on the map.",
             "description2": "At the north end of Gaptooth Ridge mine, just by the first letter 'T'  in 'Gaptooth', there is often a traveller campsite to defend. Solo lobbies are best of course."},
    ...
    {"name": "Distance non-player enemy dragged from horseback", "key": "mpgc_lasso_enemy_horseback_dragged",
             ...
             "description2": "Find a lone traveller out on the open road, lasso them and release them. They should turn red on the map, so lasso them again and drag them behind you for a while."},
    ...
    {"name": "Distance rowed a boat or canoe", "key": "mpgc_distance_rowed_boat", "category": ["menu", "boats"],
             "description": "Head to the shores of Flat Iron Lake, west of Rhodes. There are usually some boats or canoes passing by the shore which can be hijacked. Prepare to be patient. Solo lobbies work much better though."},
    ...
    {"name": "Distance traveled by train", "key": "mpgc_distance_train", "category": ["menu", "trains"],
             "description": "Fast travel to MacFarlane's Ranch for the easiest place to catch a train. Empty lobbies work best.",
             "description2": "Drive a train from MacFarlane's Ranch all the way to Mercer Station, it's the perfect distance."},
    ...
    {"name": "Distance traveled on mount", "key": "mpgc_distance_mount",
             "description": "Just ride your horse around for a while. Simple."},
    ...
    {"name": "Ducks skinned", "key": "mpgc_ducks_skinned", "category": ["animal", "duck_mallard"],
             ...
             "description2": "Mattock Pond, north of Rhodes, is a good place to find some ducks around the water."},
    {"name": "Eagles plucked", "key": "mpgc_eagles_skinned", "category": ["animal", "eagle_golden"], "showgoal": "yes",
             ...
             "description2": "Head to Annesburg, and go to the junction for the river crossing just southwest of Deer Cottage. To the east are some cliffs visible from the road, and during the day you will usually find an eagle perched on top of them. Change lobbies to get a spawn.",
             "description3": "South west of Riggs Station, head past Old Man Jones, and then head towards Fort Riggs. Crossing the wooden bridge over the river you will often see a Golden Eagle perched on it during the day. More eagles just to the left of the 'Z' on the map as well.",
             "description4": "From Wapti, head west to the wooden bridge at Whinyard Strait. South West of there, on a cliff overlooking the railway is often a Bald Eagle from 5am to 7pm.",
             "description5": "On the Owanjila Dam, near Strawberry, there is often one. Or it might be on the cliff around the T in Strawberry."},
    ...
    {"name": "Facial appearance updated at a Barber", "key": "mpgc_customization_facial_appearance", "category": ["shops", "barber"],
             "description": "Go to the Barber at Blackwater, Saint Denis or Valentine, and change make-up, beards or moustaches."},
    ...
    {"name": "Fish caught weighing at least 5 lbs (2.2 kg)", "key": "mpgc_fish_size_caught", "category": ["shops", "tackle"],
             "description": "At Blackwater, you can find massive Lake Sturgeon in the lake just in front of the butchers."},
    ...
    {"name": "Fish caught with food", "key": "mpgc_fish_caught_food", "category": ["shops", "tackle"],
             "description": "Head to Van Horn and then north past the stables to the waters edge there. Often a lot of easy fish to catch with bread, or corn."},
    ...
    {"name": "Flying birds killed", "key": "mpgc_flying_bird_kills",
             ...
             "description2": "Ride out of Armadillo along the railway line towards Mercer Station. That road usually has a number of birds flying overhead."},
    ...
    {"name": "Foxes skinned", "key": "mpgc_foxes_skinned", "category": ["animal", "fox_red"],
             ...
             "description2": "Try the western end of Big Valley, just around the 'W' of 'WEST ELIZABETH' on the map.",
             "description3": "There are a number of fox spawn points in a circle around the edge of Armadillo, with the bulk of them to the north of the town."},
    ...
    {"name": "Go On-Call and complete a Story mission", "key": "mpgc_story_mission_wins_on_call",
             ...
             "description2": "From the left menu, use Quick Join to do a Story Mission On-Call. Maybe have low honour to get some of the more interesting mid-story missions."},
    {"name": "Golden Currants picked", "key": "mpgc_golden_currant_picked", "category": ["plants", "golden_currant"],
             ...
             "description2": "Got to Van Horn, and then head west to Fort Brennard. Plenty of Golden Current plants in the area surrounding it.",
             "description3": "Fast travel to Manzanita Post, and head north to the little triangular junction. There are some directly north, and then head south east to find some quite close to the corner of the junction where the roads meet."},
    ...
    {"name": "Hideouts cleared", "key": "mpgc_hideout_clear", "category": ["menu", "hideouts"],
             "description": "Hanging Dog Ranch at the west end of Big Valley, between 6pm and 6am, seems more common than some. A solo lobby will help a lot. ",
             "description2": "Stow a 3 star animal on your horse, and be in a solo lobby to increase chances.\nTwin Rocks near Armadillo during the day is a good one to try.",
             "description3": "Solo lobby, and try a 3 star animal stowed on your horse as well. Pike's Basin next to MacFarlane's Ranch between 6am and 4pm often appears and is next to a fast travel post.",
             "description4": "From Valentine, head west to Cumberland Falls between noon and midnight, there might be one there. Solo lobby, try having a 3 star animal stowed on your horse too."},
    ...
    {"name": "Horses fed", "key": "mpgc_horse_fed",
             "description": "Doesn't have to be five different horses, you can just feed your own horse five times."},
    ...
    {"name": "Iguanas skinned", "key": "mpgc_iguanas_skinned", "category": ["animal", "iguanadesert"],
             ...
             "description2": "The big island with the shipwreck, west of Rhodes in Flat Iron Lake, usually has a number of Green Iguanas languishing on the beaches."},
    {"name": "Indian Tobacco picked", "key": "mpgc_indian_tobacco_picked", "category": ["plants", "indian_tobacco"],
             ...
             "description2": "Head to Manzanita Post, and then cross the road into the trees to the east. There is a patch just above the 'Z' on the map, and then another patch just a little to the NNW of those.",
             "description3": "Fast travel to Emerald Station and go north to the triangle of railway lines. There's some in the eastern corner, then follow the line around bend, some on the left, and some on the right, all no further than the 'O' on the map"},
    ...
    {"name": "Jumped onto a horse from a 3m height", "key": "mpgc_horse_jump_from_height", "showgoal": "no",
             ...
             "description2": "Climb on to the stable roof at Tumbleweed. You need to just get on to the highest section of the roof before you jump, but don't go all the way to the top.",
             "description3": "Go to Rathskeller Fork, north of Tumbleweed. Jump off from the apex off the barn roof to complete."},
    {"name": "Lake Sturgeon caught", "key": "mpgc_fish_caught_lake_sturgeon", "category": ["fish", "lake_sturgeon"], "showgoal": "yes",
    ...
    {"name": "Largemouth Bass caught", "key": "mpgc_fish_caught_largemouth_bass", "category": ["fish", "largemouthbass"],
             "description": "Head due west from the big house at Braithwaite Manor, and fish off the southeastern tip of the long thin island in Flat Iron Lake. Crawfish or Special Spinner required.",
             "description2": "Aurora Basin in Tall Trees has plenty of Largemouth Bass in it. Use a special spinner."},
    ...
    {"name": "Longnose Gar caught", "key": "mpgc_fish_caught_longnose_gar", "category": ["fish", "longnosegar"], "showgoal": "yes",
             "description": "The bootshaped pond to the left of the word Bayou on the map, south west of Lagras has them in. The special swamp lure works well, they are massive fish with a long thin snout."},
    {"name": "Loons skinned", "key": "mpgc_loon_skinned", "category": ["animal", "loon_pacific"], "showgoal": "yes",
             ...
             "description3": "West of Braithwaite Manor, on the long thin island in Lake Flat Iron you will often find some. Run around the beach of the largest island as well."},
    ...
    {"name": "Moose skinned", "key": "mpgc_moose_skinned", "category": ["animal", "moose"],
             "description": "A good place to find one is between 6am and 4pm in front of Hanging Dog Ranch in Big Valley, just by the S-Bend in the river. Solo lobbies are a massive help here."},
    ...
    {"name": "Non-player enemies grappled to the ground", "key": "mpgc_enemies_grappled_to_ground",
             "description": "Go brawling with the Del Lobos at Thieves Landing, or when doing a trader delivery you'll likely have a load of enemies to grapple at the delivery location.",
             "description2": "Head to any town, and give one of the rougher looking cowboys a shove, that should trigger them to become an enemy and start brawling, then you can charge at them and knock them over."},
    {"name": "Non-player enemies killed at long range", "key": "mpgc_enemies_killed_from_long_distance",
             ...
             "description2": "Revenue agents at a moonshiner roadblock and a sniper rifle are an excellent way to get this challenge done."},
    {"name": "Non-player enemies killed from cover", "key": "mpgc_enemies_killed_cover",
             ...
             "description2": "Try holding off lawmen from inside the saloon at Valentine, you can hide by the door and pick them off as they ride up."},
    ...
    {"name": "Non-player enemies killed while in Dead Eye", "key": "mpgc_enemies_killed_deadeye",
             "description": "Trade Route is rather good for this challenge.\nSomething like a moonshine delivery is good too, you can shoot the revenue men who give chase.",
             "description2": "Moonshine deliveries will allow you to shoot the revenue men who give chase.\nTrader re-supply missions also offer a good opportunity."},
    ...
    {"name": "Non-player enemies killed with a Maxim Gun", "key": "mpgc_enemies_killed_gatling_maxim", "category": ["menu", "hideouts"],
             ...
             "description2": "Hanging Dog Ranch in Big Valley will sometimes have a moonshiner sabotage mission to do, and you can sneak in the back of the barn via the roof, and get to the Maxim gun fairly easily."},
    ...
    {"name": "Non-player enemies lassoed from horseback", "key": "mpgc_lasso_enemy_horseback",
             "description": "Head to Thieves Landing and lasso people standing around, they'll all count for this as Del Lobos."},
    {"name": "Non-player enemies looted", "key": "mpgc_enemies_looted",
             "description": "Gang hideouts are great for this.",
             "description2": "Moonshine roadblocks will have plenty of bodies to loot.",
             "description3": "The destination battle at the end of trader deliveries will yield bodies to loot.",
             "description4": "Try doing Harriet's Legendary Animal Sightings, there's often lots of poachers to kill and loot."},
    ...
    {"name": "North American Raccoons skinned", "key": "mpgc_raccoons_skinned", "category": ["animal", "racoon"],
             "description": "Raccoons are mainly nocturnal, so hunt these after dark.\nAround Rhodes, mainly to the south or west is a decent area. The big island in Lake Flat Iron opposite Clemens Point usually has some.",
    ...
    {"name": "Oleander Sage picked", "key": "mpgc_oleander_picked", "category": ["plants", "oleander_sage"],
             "description": "At Lagras, there's a patch in the trees by the road just near Harriet, and there's more just north of that.\nThey're inside the horseshoe curve in the road, between the letters 'L' and 'M' on the map.\nFurther on too, just below 'A' and 'R' on the map there's a patch either side of the road.",
             "description2": "Go to Rhodes then head to Shady Belle, and to the northeast of the mansion, just past the tiny jetty you'll find a number of Oleander Sage plants under the trees, should be five of them there."},
    {"name": "Oregano picked", "key": "mpgc_oregano_picked", "category": ["plants", "oregano"],
             ...
             "description2": "Just on the north side of the Tumbleweed Mansion, are a couple of patches of Oregano.\nHead a little north of the house if not enough in the first patch."},
    ...
    {"name": "Panthers killed", "key": "mpgc_panthers_killed", "category": ["animal", "panther"], "showgoal": "yes",
             ...
             "description2": "Just south of Lagras, the Legendary Ghost Panther can often be found, along with 2 companion pathers, giving plenty of opportunity to get this challenge. Solo lobbies work best of course, and often at night."},
    {"name": "Parasol Mushrooms picked", "key": "mpgc_parasol_mushroom_picked", "category": ["plants", "parasol_mushroom"],
             ...
             "description2": "Just to the north of the Tumbleweed Mansion, there's one patch, and another if you head north a little.\nOr go South out of Blackwater, and just past the first house on the left there's some, next to the boundary line on the map and to the south."},
    ...
    {"name": "Perch caught", "key": "mpgc_fish_caught_perch", "category": ["fish", "perch"],
             ...
             "description2": "From Valentine, head west, and take the curved road that goes under the bridge. This should bring you through a little gulley down to the Dakota River. This is a good spot to find perch.",
             "description3": "Follow the road west from the Beaver Hollow cave campsite near Annesburg. Down around the big rocks that sit in the waters of the Kamassa River you can often find perch."},
    ...
    {"name": "Placed top 3 in a Showdown", "key": "mpgc_showdown_wins",
             "description": "This should read 'Placed top 3 or on a winning team in a Showdown' so you can try Takeovers and get on the winning team, or an Elimination Showdown and hide for as long as possible."},
    {"name": "Placed top 3 in a Takeover Showdown", "key": "mpgc_series_takeover_wins",
             "description": "It should be '...or on the winning team', but it can be tricky to get matchmaking for this sometimes."},
    ...
    {"name": "Placed top 3 with a score in Free Roam Events", "key": "mpgc_fme_wins",
             ...
             "description2": "Would recommend Manhunt. Wait until the last 5 secs to join for lower numbers, then immediately pick the furthest target for higher points. Tonic up and ride fast."},
    ...
    {"name": "Player kills from the hip in Free Roam Events", "key": "mpgc_players_killed_from_hip_fme", "showgoal": "yes",
             ...
             "description2": "As this is essentially free aim, try a shotgun without aiming first, just use the fire button.\nCold Dead Hands and King Of The Castle are good bets for completion."},
    ...
    {"name": "Player kills in Dead Eye in Showdowns", "key": "mpgc_players_deadeye_showdown", "showgoal": "yes",
             "description": "A bow and arrow is a nice way to achieve this, in something like Public Enemy."},
    ...
    {"name": "Player kills with explosives in Showdowns", "key": "mpgc_players_killed_explosives_showdown", "showgoal": "yes",
             ...
             "description2": "Explosive ammo or Dynamite Arrows is the best way to achieve this. You need to be in a showdown that allows standard weapons, so Shootout is usually the best bet."},
    {"name": "Player kills with melee in Free Roam Events", "key": "mpgc_players_killed_melee_fme", "showgoal": "yes",
             "description": "Cold Dead Hands, and King Of The Castle are good events. Take stamina tonics, then knock down and subdue players. Use a bolas to incapacitate them, maybe a hammer to finish them off.",
             "description2": "Tonics, and change your ability cards, something like 'Of Single Purpose' and 'To Fight Another Day' is great for Melee, maybe Slippery Bastard too, and equip the hammer and get sprinting, knocking over and smashing players in the head.",
             "description3": "A bolas will disable players and you can then tie them up and beat them to death."},
    {"name": "Player kills with melee in Showdowns", "key": "mpgc_players_killed_melee_showdown", "showgoal": "yes",
             "description": "If you have a willing friend, an Elimination Showdown is a good bet, you can just rugby tackle and subdue them. Otherwise this can be very tough."},
    ...
    {"name": "Player kills with thrown weapons in Free Roam Events", "key": "mpgc_players_killed_throw_fme", "showgoal": "yes",
             "description": "Disable opponents with a bolas, then you can take you time with a thrown weapon to kill",
             "description2": "Cold Dead Hands, King Of The Castle, Fools Gold or Railroad Baron are the best events to try this in.\nThrowing knives or tomahawks, together with Dead Eye headshots are a good idea, though dynamite should also work but it's harder to kill with.",
             "description3": "Use a bolas to make them an easy target first. Cold Dead Hands, King Of the Castle, and Fools Good are good ones."},
    ...
    {"name": "Prairie Chickens skinned", "key": "mpgc_prairiechicken_skinned", "category": ["animal", "prairiechicken"],
             "description": "South of Valentine, you want to be at the junction between the 'N' and 'E' of 'NEW' on the map. There are Prairie Chickens lurking in the grass to the east of the path, so run in with a gun ready as they take flight. Use a new lobby to get more spawns.",
             "description2": "Where the road from Cornwall Kerosene and Tar joins the road at Twin Stack Pass is a great place, there are spawn points at the junction where all the roads meet, near the 'W' of 'NEW HANOVER' on the map.",
             "description3": "During the day, south east of MacFarlane's Ranch, in the vicinity of the old wooden bridge over the trail down to Brittlebush Trawl, there's often some in the long grass by the small clump of trees."},
    ...
    {"name": "Ram's Head picked", "key": "mpgc_rams_head_picked", "category": ["plants", "rams_head"],
             ...
             "description2": "Travel to Annesburg, then ride up the railway line to Brandywine Drop, cross the bridge, then cross the next tiny trestle, and head left into the undergrowth. Rams Head patches in this area, and also if you head over the tracks towards the waterfall, look just east of the same contour line."},
    {"name": "Rams skinned", "key": "mpgc_rams_skinned", "category": ["animal", "bighornram_desert"],
             "description": "Can be difficult, but the challenge is misleading. Desert Bighorn Sheep also count as well as Rams.\nSouth of Tumbleweed, look near the letter E in New Austin on the map.",
             "description2": "Bighorn sheep count as well as the rams. A good spot to try is the north-west end of Big Valley, past the house on stilts.\nCattail Pond, west of Valentine, is also a good spot to find them."},
    {"name": "Raspberries picked", "key": "mpgc_red_raspberry_picked", "category": ["plants", "red_raspberry"],
             ...
             "description3": "Big Valley has a number of raspberry plants along the length of the grassy area, go from one end to the other.",
             "description4": "The big island in Lake Flat Iron, off the coast of Clemens Point near Rhodes, has quite a lot of Raspberry bushes.",
             "description5": "Go to Rhodes, then head north to Southfield Flats and the pond opposite the big red grain store. There's more than 5 raspberry bushes around the edge of the water."},
    ...
    {"name": "Rock Bass caught", "key": "mpgc_fish_caught_rock_bass", "category": ["fish", "rockbass"],
             ...
             "description2": "Aurora Basin in Tall Trees is a decent place to fish for Rock Bass. Cheese bait is recommended but not essential.",
             "description3": "The Dakpta River, just down from Cumberland Falls is a good spot for these, using cheese bait to avoid most of the other fish. Try the east bank, just a little above the 'r' in 'River' on the map."},
    ...
    {"name": "Seagulls plucked", "key": "mpgc_seagulls_skinned", "category": ["animal", "seagull_herring"],
             ...
             "description2": "Try the Annesburg and Van Horn coastlines. The rocks south of Van Horn lighthorse often have plenty to shoot.",
             "description3": "There are often seagulls on the piers at Thieves Landing."},
    ...
    {"name": "Small animal carcasses broken down", "key": "mpgc_craft_broke_down_small_animals",
             "description": "Easiest method here is to open your satchel, select the materials tab and then break down fish."},
    {"name": "Small bird carcasses collected", "key": "mpgc_songbirds_collected",
             "description": "Head to Wapiti, and then travel southwest past Cotarra Springs towards Whinyard Strait. There's nearly always small birds alongside the path during the day, they often perch on the wooden bridge over Whinyard Strait. Have a gun ready to fire."},
    ...
    {"name": "Snakes skinned", "key": "mpgc_snakes_skinned", "category": ["animal", "snake"],
             ...
             "description2": "There is often a rattlesnake below the 'P' of 'Scratching Post', south of Tumbleweed."},
    ...
    {"name": "Spoonbills skinned", "key": "mpgc_spoonbill_skinned", "category": ["animal", "roseatespoonbill"],
             "description": "During the day, head to Lagras, then go to the Kamassa river bank opposite Harriet, and there are usually a lot of spoonbills there, sitting on the little wooden bridges.\nAs a bonus, she'll call you a murderer as you pluck them too."},
    {"name": "Squirrels collected", "key": "mpgc_squirrel_skinned", "category": ["animal", "squirrel_grey"],
             ...
             "description2": "Go to Blackwater, then head out on the southern road, past the first house on the left. When you get to the town boundary, head left towards the trees on the cliffs, as nearly always squirrels underneath them."},
    ...
    {"name": "Striped Skunks skinned", "key": "mpgc_skunks_skinned", "category": ["animal", "skunk"],
             ...
             "description2": "Head to Riggs Station, then head northeast along the road. You will see a couple of fir trees on your left just past the little bend in the road, and there's nearly always a skunk or two there at night. Swap lobbies for more spawns.",
             "description3": "Head north out of Butchers Creek, and just past the turnoff to the cave camp, just below the 'N' of 'ANNESBURG' on the map, is a section of road with plenty of skunks usually."},
    {"name": "Successfully fended off an ambush", "key": "mpgc_dynamic_ambush", "category": ["menu", "ambush"],
             "description": "The road through Black Bone Forest, at the western side of Big Valley is usually a pretty reliable ambush. Much more likely in a solo lobby though.",
             "description2": "Head west out of MacFarlane's Ranch, and keep going west along the road with Pike's Basin on the right. There's often an ambush there when in a solo lobby.",
             "description3": "The loop of roads beside the Dakota River as it travels below Painted Sky near Valentine has a number of ambush spots. Try a solo lobby.",
             "description4": "Go to Lagras, head south, then turn west past Hagen Orchards towards the lake that looks like a boot at Bayall Edge. That road west of the lake often has an ambush. Solo lobby works best.",
             "description5": "Head to Wapiti, then set a marker for 'Chez Porter' just west of Whinyard Strait. Stay there for a moment or two, and then head back to Wapiti, there's often an ambush as you cross the wooden bridge."},
    {"name": "Telegram missions completed", "key": "mpgc_telegram_mission_wins", "showgoal": "yes",
             "description": "Go to Van Horn, then start the 'A Tough Businness' Telegram mission called 'Good and Dead'. Go immediately to the market and try the North and West entrances for the suspect, otherwise he's inside the market. Kill, loot and escape. Stealthy is best."},
    ...
    {"name": "Vaults on horseback", "key": "mpgc_horse_vaults",
             ...
             "description2": "From Rhodes, head north to Southfield Flats, and there's a nice low fence there around the homestead with plenty of room to circle round."},
    {"name": "Violet Snowdrop picked", "key": "mpgc_violet_snowdrop_picked", "category": ["plants", "violet_snowdrop"],
             ...
             "description2": "Fast travel to Wapiti, then travel towards Cotarra Springs. In the grass, near the fallen tree trunk by the first large pool is a patch. There are some more in the trees across the road to the southeast."},
    {"name": "Virginia Opossums skinned", "key": "mpgc_opossums_skinned", "category": ["animal", "possum"],
             ...
             "description2": "Seem to find quite a few to just the east of Emerald Ranch on the other side of the railway tracks, so worth trying there."},
    ...
    {"name": "Vultures plucked", "key": "mpgc_vultures_skinned", "category": ["animal", "vulture_western"],
             ...
             "description2": "The moonshine shack below the cliffs near Armadillo often has one perched on the roof during the day."},
    ...
    {"name": "Western Toads collected", "key": "mpgc_toads_skinned", "category": ["animal", "toad"],
             ...
             "description2": "The largest island in Flat Iron Lake, west of Rhodes has plenty. Just circumnavigate along the beach and kill with a bow and small game arrows for the best quality."},
    {"name": "Whole animal carcasses sold", "key": "mpgc_shop_animal_whole_sell", "category": ["shops", "butcher"],
             "description": "Sell at any butchers, ones at Blackwater and Rhodes are very close to the fast travel posts. Birds and small animals from your satchel are suitable, fish are not though."},
    ...
    {"name": "Wild Carrots picked", "key": "mpgc_wild_carrots_picked", "category": ["plants", "wild_carrots"],
             ...
             "description2": "Head south east across the railway line at Valentine, there's some just by the crossroads, then head south along the road till just before it crosses the railway line, and there's some on the left. If you need more keep going along the railway line, there's more around where the track crosses the road again."},
    ...
    {"name": "Wild Mint picked", "key": "mpgc_wild_mint_picked", "category": ["plants", "wild_mint"],
             "description": "The big island in Lake Flat Iron, just off the coast of Clemens Point near Rhodes, has a lot of Wild Mint plants at the south end.",
             "description2": "Big Valley has a lot of Wild Mint if you follow the stream that winds through it. More than enough plants around for the challenge.",
             "description3": "Just to the east of the southern road out of Blackwater, there's a number of plants around the boundary line."},
    {"name": "Wintergreen Berries picked", "key": "mpgc_wintergreen_berry_picked", "category": ["plants", "wintergreen_berry"],
             ...
             "description2": "Head north out of Valentine, and turn left to Six Point Cabin. There's a couple of patches left of the road, opposite the entrance track and a touch further north. Remaining ones around the little tracks above 'OR' in 'FOREST' on the map."},
    {"name": "Wolves killed", "key": "mpgc_wolves_killed", "category": ["animal", "wolf_gray"],
             ...
             "description2": "The legendary bounty 'The Wolf Man' has plenty of wolves to kill. From the start of the mission, pick the right hand yellow target, and as you come over the hill, use a scoped rifle to kill wolves at a distance. You can quit out if you want after killing three.",
             "description3": "The Blood Money Crime, 'The Railroad Contract Part 1' has wolves to shoot and skin at the railroad camp, easy kills.",
             "description4": "Go to Wapiti, then ride down towards Cotarra Springs. Wolves often attack as you come out of the trees where the road forks in two below the 'R' of 'AMBARINO' on the map."},
    {"name": "Yarrow picked", "key": "mpgc_yarrow_picked", "category": ["plants", "yarrow"],
             ...
             "description3": "Go to Emerald Station and head north a little, there's a triangle of railway lines on the map. Yarrow plants can be found roughly in the middle of each side of the triangle, just outside of the railway tracks. Head around the dead end curve, plenty on the left side of the lines too."},
]
...
trader = [
    ...
    {"name": "Distance Delivery Wagon traveled on mission", "key": "mprc_trader_travel_wagon",
             ...
             "description2": "Check challenge total is updating as you set off",
             "description3": "Solo lobbies more reliable, check counter at start"},
    ...
    {"name": "Resupply missions completed", "key": "mprc_trader_resupply_completed", "showgoal": "yes",
             "description": "Buggy, often won't register in public lobbies",
             "description2": "Best to be in a solo lobby so it registers"},
...
collector = [
    ...
    {"name": "Bird Eggs found", "key": "mprc_collector_bird_eggs_found", "showgoal": "yes",
             ...
             "description2": "You can pick up to 5 duck eggs in one go",
             "description3": "Carry 5 duck eggs, and you can then pick another 5",
             "description4": "Duck, goose or loon eggs can be collected in multiples"},
    ...
    {"name": "Collectibles looted from non-player enemies", "key": "mprc_collector_items_looted_enemy", "showgoal": "yes",
             "description": "Gold Teeth count for this",
             "description2": "Moonshiner roadblock NPC's usually carry alchohol",
             "description3": "Poacher NPC's usually carry collectables",
             "description4": "Trade run end fight NPC's often have some"},
...
bounty_hunter = [
    ...
    {"name": "Bounties brought in from West Elizabeth posters", "key": "mprc_bounty_location_west_elizabeth", "showgoal": "yes",
             "description": "Strawberry, Blackwater, Wallace Station, & Riggs Station"},
    ...
    {"name": "Bounty completed without killing an enemy or bounty target", "key": "mprc_bounty_completed_no_kills",
             ...
             "description2": "Etta Doyle bounty can work but isn't reliable",
             "description3": "Bard's Crossing train track bounty might work"},
    ...
    {"name": "Bounty targets lassoed from horseback", "key": "mprc_bounty_used_lasso_horseback", "showgoal": "yes",
             ...
             "description2": "You can lasso the same target over and over",
             "description3": "Lasso, release, lasso, release, lasso the same target"},
