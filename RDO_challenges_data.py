...
predefined_challenges = [
    ...
    {"name": "Yarrow picked", "key": "mpgc_yarrow_picked", "category": ["plants", "yarrow"],
             ...
             "description3": "Go to Emerald Station and head north a little, there's a triangle of railway lines on the map. Yarrow plants can be found roughly in the middle of each side of the triangle, just outside of the railway tracks."},
]
