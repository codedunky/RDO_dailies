...
predefined_challenges = [
    ...
    {"name": "Boars skinned", "key": "mpgc_boars_skinned", "category": ["animal", "boar"],
             "description": "Often find boars on the road past Harriet at Lagras, just keep following it along the bend to the east.\nThey're in the trees and on the mudflats usually, listen for the squeals.\nThe woods around Bolger Glade are good for hunting too."},
    ...
    {"name": "Desert Sage picked", "key": "mpgc_desert_sage_picked", "category": ["plants", "desert_sage"],
             "description": "Head south out of Tumbleweed, and at the crossroads next to the 'E' on the map you'll find the plants."},
...
trader = [
    ...
    {"name": "Large animal carcasses donated to Cripps", "key": "mprc_trader_supplies_donated_animal_large",
             "description": "Deer, Pronghorn, Bighorn Rams, Panther, Cougar, Wolf"},
