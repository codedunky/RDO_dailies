...
predefined_challenges = [
    ...
    {"name": "Western Toads collected", "key": "mpgc_toads_skinned", "category": ["animal", "toad"],
             "description": "Follow the railway tracks north out of the city and into Bluewater Marsh. The mud flats near where the railway line forks over the water is a good place to hunt for toads. So is the area near the burnt out fishing shack at Copperhead Landing, just NE of that."},
