...
predefined_challenges = [
    ...
    {"name": "American Bullfrogs collected", "key": "mpgc_bullfrogs_skinned", "category": ["animal", "frogbull"],
             "description": "Fast travel to Lagras, and ride past Harriet. There are bullfrogs around the junction for the bridge.\nThere are plenty in the mud alongside the large bend in the road.\nCarry on eastwards, you'll find some next to the railway line where the crocodiles gather as well.\nFurther north on the spur of land above Copperhead Landing, there are often bullfrogs to catch."},
    ...
    {"name": "Eagles plucked", "key": "mpgc_eagles_skinned", "category": ["animal", "eagle_golden"], "showgoal": "y"},
    {"name": "Egrets skinned", "key": "mpgc_egret_skinned", "category": ["animal", "egret_reddish"], "showgoal": "y",
    ...
    {"name": "Geese skinned", "key": "mpgc_goose_skinned", "category": ["animal", "goosecanada"],
             "description": "Head to Heartland Overflow by Emerald Ranch, and just below the letter 'r' in 'Overflow' there are some trees where you can usually find a flock of resting geese. You can kill 5 or 6 as they take flight. Lobby swap until they spawn."},
    ...
    {"name": "Herons skinned", "key": "mpgc_herons_skinned", "category": ["animal", "heron_greatblue"],
             "description": "North West of Rhodes, the bay just below Clemens Point camp often has a number of herons."},
    ...
    {"name": "Other players photographed", "key": "mpgc_photograph_player", "showgoal": "y"},
    {"name": "Owls plucked", "key": "mpgc_owls_skinned", "category": ["animal", "owl_great"], "showgoal": "y",
    ...
    {"name": "Player headshot kills in Free Roam Events", "key": "mpgc_players_headshot_fme", "showgoal": "y",
             "description": "King Of The Castle, Cold Dead Hands, Railroad Baron, and Fools Gold are probably the best option."},
    {"name": "Player headshot kills in Posse Versus", "key": "mpgc_players_headshot_pv", "showgoal": "y"},
    {"name": "Player headshot kills in Showdowns", "key": "mpgc_players_headshot_showdown", "showgoal": "y"},
    {"name": "Player kills from cover in Free Roam Events", "key": "mpgc_players_cover_fme", "showgoal": "y"},
    {"name": "Player kills from cover in Showdowns", "key": "mpgc_players_cover_showdown", "showgoal": "y"},
    {"name": "Player kills from the hip in Free Roam Events", "key": "mpgc_players_killed_from_hip_fme", "showgoal": "y"},
    {"name": "Player kills from the hip in Showdowns", "key": "mpgc_players_killed_from_hip_showdown", "showgoal": "y"},
    {"name": "Player kills in Dead Eye in Free Roam Events", "key": "mpgc_players_deadeye_fme", "showgoal": "y"},
    {"name": "Player kills in Dead Eye in Showdowns", "key": "mpgc_players_deadeye_showdown", "showgoal": "y"},
    {"name": "Player kills in Free Roam Events", "key": "mpgc_players_killed_fme", "showgoal": "y"},
    {"name": "Player kills in Posse Versus", "key": "mpgc_players_killed_pv", "showgoal": "y"},
    {"name": "Player kills in Showdowns", "key": "mpgc_players_killed_showdown", "showgoal": "y"},
    {"name": "Player kills with a Bow in Free Roam Events", "key": "mpgc_players_killed_bow_fme", "showgoal": "y"},
    {"name": "Player kills with a Bow in Showdowns", "key": "mpgc_players_killed_bow_showdown", "showgoal": "y"},
    {"name": "Player kills with a Pistol in Free Roam Events", "key": "mpgc_players_killed_pistol_fme", "showgoal": "y"},
    {"name": "Player kills with a Pistol in Showdowns", "key": "mpgc_players_killed_pistol_showdown", "showgoal": "y"},
    {"name": "Player kills with a Repeater in Free Roam Events", "key": "mpgc_players_killed_repeater_fme", "showgoal": "y"},
    {"name": "Player kills with a Repeater in Showdowns", "key": "mpgc_players_killed_repeater_showdown", "showgoal": "y"},
    {"name": "Player kills with a Revolver in Free Roam Events", "key": "mpgc_players_killed_revolver_fme", "showgoal": "y"},
    {"name": "Player kills with a Revolver in Showdowns", "key": "mpgc_players_killed_revolver_showdown", "showgoal": "y"},
    {"name": "Player kills with a Rifle in Free Roam Events", "key": "mpgc_players_killed_rifle_fme", "showgoal": "y"},
    {"name": "Player kills with a Rifle in Showdowns", "key": "mpgc_players_killed_rifle_showdown", "showgoal": "y"},
    {"name": "Player kills with a Shotgun in Free Roam Events", "key": "mpgc_players_killed_shotgun_fme", "showgoal": "y"},
    {"name": "Player kills with a Shotgun in Showdowns", "key": "mpgc_players_killed_shotgun_showdown", "showgoal": "y"},
    {"name": "Player kills with explosives in Free Roam Events", "key": "mpgc_players_killed_explosives_fme", "showgoal": "y"},
    {"name": "Player kills with explosives in Showdowns", "key": "mpgc_players_killed_explosives_showdown", "showgoal": "y",
    ...
    {"name": "Player kills with melee in Free Roam Events", "key": "mpgc_players_killed_melee_fme", "showgoal": "y",
             "description": "Stamina tonics, then knock down and subdue players."},
    {"name": "Player kills with melee in Showdowns", "key": "mpgc_players_killed_melee_showdown", "showgoal": "y"},
    {"name": "Player kills with throwing weapons in Showdowns", "key": "mpgc_players_killed_throw_showdown", "showgoal": "y"},
    {"name": "Player kills with thrown weapons in Free Roam Events", "key": "mpgc_players_killed_throw_fme", "showgoal": "y"},
    {"name": "Player stats boosted by tonics", "key": "mpgc_consumable_tonics_oils_used", "category": ["shops", "general_store"], "showgoal": "y"},
    {"name": "Players headshot with a Bow in Free Roam Events", "key": "mpgc_players_headshot_bow_fme", "showgoal": "y"},
    {"name": "Players headshot with a Bow in Showdowns", "key": "mpgc_players_headshot_bow_showdown", "showgoal": "y"},
    {"name": "Players revived", "key": "mpgc_players_revived", "showgoal": "y",
    ...
    {"name": "Waves completed in Call to Arms", "key": "mpgc_protect_waves_completed", "showgoal": "y"},
