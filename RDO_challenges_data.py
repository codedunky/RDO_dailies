...
predefined_challenges = [
    ...
    {"name": "Animal meat sold", "key": "mpgc_shop_animal_meat_sell", "category": ["shops", "butcher"],
             "description": "Sell at any butchers, Rhodes and Blackwater have one near the fast travel post."},
    ...
    {"name": "Western Ravens plucked", "key": "mpgc_ravens_skinned", "category": ["animal", "raven"],
             "description": "Ravens can be found all over, but west of Armadillo around Mercer Station is a good spot.\nKilling an animal will often draw them in to your location."},
